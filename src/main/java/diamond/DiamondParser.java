...
public class DiamondParser extends Parser {
	...
	public static final int
		...
		RULE_alloc = 17, RULE_deref = 18, RULE_lam = 19, RULE_tyLam = 20, RULE_let = 21, 
		RULE_funDef = 22, RULE_funDefOrExpr = 23, RULE_program = 24;
	private static String[] makeRuleNames() {
		return new String[] {
			"qualElem", "qualElems", "qual", "idQty", "param", "paramList", "namedParamList", 
			"funTy", "tyParam", "tyParamList", "tyFunTy", "ty", "qty", "op2", "op1", 
			"value", "expr", "alloc", "deref", "lam", "tyLam", "let", "funDef", "funDefOrExpr", 
			"program"
		};
	}
	...
	public final DerefContext deref() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_deref);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(254);
	...
	public final LamContext lam() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_lam);
		int _la;
		try {
			setState(286);
			_errHandler.sync(this);
	...
	public final FunDefOrExprContext funDefOrExpr() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_funDefOrExpr);
		try {
			setState(365);
			_errHandler.sync(this);
