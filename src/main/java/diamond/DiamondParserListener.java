...
public interface DiamondParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DiamondParser#eff}.
	 * @param ctx the parse tree
	 */
	void enterEff(DiamondParser.EffContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiamondParser#eff}.
	 * @param ctx the parse tree
	 */
	void exitEff(DiamondParser.EffContext ctx);
	/**
	 * Enter a parse tree produced by {@link DiamondParser#effs}.
	 * @param ctx the parse tree
	 */
	void enterEffs(DiamondParser.EffsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiamondParser#effs}.
	 * @param ctx the parse tree
	 */
	void exitEffs(DiamondParser.EffsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DiamondParser#args}.
	 * @param ctx the parse tree
	 */
	void enterArgs(DiamondParser.ArgsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiamondParser#args}.
	 * @param ctx the parse tree
	 */
	void exitArgs(DiamondParser.ArgsContext ctx);
	/**
	 * Enter a parse tree produced by {@link DiamondParser#tyArgs}.
	 * @param ctx the parse tree
	 */
	void enterTyArgs(DiamondParser.TyArgsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiamondParser#tyArgs}.
	 * @param ctx the parse tree
	 */
	void exitTyArgs(DiamondParser.TyArgsContext ctx);
	/**
	 * Enter a parse tree produced by {@link DiamondParser#wrapExpr}.
	 * @param ctx the parse tree
	 */
	void enterWrapExpr(DiamondParser.WrapExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link DiamondParser#wrapExpr}.
	 * @param ctx the parse tree
	 */
	void exitWrapExpr(DiamondParser.WrapExprContext ctx);
	/**
